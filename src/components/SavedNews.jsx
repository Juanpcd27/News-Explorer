          ...
          <ul className="card__container">
            <li className="card">
              ...
              <p className="card__description">
                ...
                the special occasion, Mercedes has opened a competition to be
                one of 150 names to adorn Hamilton's W15 machine at Yas Marina.
              </p>
          ...
          <ul className="card__container">
            <li className="card">
              ...
              <p className="card__description">
                ...
                will not be his last chance of fighting for F1 victories, with
                the Spaniard determined to put himself in a position to contend
                for wins again in the future.
              </p>
